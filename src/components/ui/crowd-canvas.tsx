...
const CrowdCanvas = ({
  ...
  useEffect(() => {
    ...
    const finalSrc = src || (inverted ? "/images/peeps/all-peeps-inverted.png" : "/images/peeps/all-peeps.png");
  ...
  }, [src, rows, cols, inverted]);

  return (
    <canvas
      ref={canvasRef}
      className={className || "absolute bottom-0 h-[90vh] w-full pointer-events-none"}
      style={style}
    />
  );
};
